    ...
    if ($numero === '' || $monto <= 0) {
        ...
        if ($cuenta) {
            if ($cuenta['saldo'] >= $monto) {
                ...
                $mensaje = '✅ Retiro realizado correctamente. Nuevo saldo: Q' . number_format($nuevoSaldo, 2);
                $tipoMsg = 'ok';
            } else {
